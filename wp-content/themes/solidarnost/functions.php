...
//     return '<a href="'.get_permalink($post->ID).'" class="read-more">'.'Continue Reading'.'</a>';
	return '<div class="more-link" id="button-entry-more-'.$post->ID.'" onclick="expand('.$post->ID.')">več <img class="img-none" src="'.get_template_directory_uri().'/next.png"></div>';
}
...
if ( ! function_exists( 'solidarnost_excerpt' ) ) :
        function solidarnost_excerpt($limit) {
